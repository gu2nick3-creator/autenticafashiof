            ...
            <div className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 px-5 py-4 backdrop-blur">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">Modal centralizado com todas as opções atuais do painel e campo de SKU incluído.</p>
                </div>
                <button
                  onClick={resetForm}
            ...
            <div className="space-y-6 p-5 md:p-6">
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                  ...
                  <Field label="SKU">
                    <input value={form.sku || ''} onChange={(e) => setForm((prev) => ({ ...prev, sku: e.target.value }))} className="admin-input" placeholder="Ex.: GESSICA-PRETO-35" />
                  </Field>
